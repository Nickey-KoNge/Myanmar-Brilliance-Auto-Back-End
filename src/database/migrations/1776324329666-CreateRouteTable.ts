...
export class CreateRouteTable1776324329666 implements MigrationInterface {
  name = 'CreateRouteTable1776324329666';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "master_trips"."route" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "route_name" character varying(100) NOT NULL, "start_location" character varying(100) NOT NULL, "end_location" character varying(100) NOT NULL, "status" character varying(20) NOT NULL DEFAULT 'Active', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_08affcd076e46415e5821acf52d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5e2df1067075729388a504db02" ON "master_trips"."route" ("route_name") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_60a314ba7efe0140b63242ddb7" ON "master_trips"."route" ("status") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "master_vehicle"."driver_assigns" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "master_vehicle"."driver_assigns" ALTER COLUMN "id" SET DEFAULT uuid_generate_v7()`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "master_vehicle"."driver_assigns" ALTER COLUMN "id" SET DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "master_company"."refresh_tokens" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "master_trips"."IDX_60a314ba7efe0140b63242ddb7"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_trips"."IDX_5e2df1067075729388a504db02"`,
    );
    await queryRunner.query(`DROP TABLE "master_trips"."route"`);
  }
}
