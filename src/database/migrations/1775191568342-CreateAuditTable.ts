...
export class CreateAuditTable1775191568342 implements MigrationInterface {
  name = 'CreateAuditTable1775191568342';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(
      `CREATE TABLE "master_audit"."audit" ("id" uuid NOT NULL DEFAULT uuid_generate_v7(), "entity_name" character varying(100) NOT NULL, "entity_id" character varying(100) NOT NULL, "action" character varying(20) NOT NULL, "old_values" jsonb, "new_values" jsonb, "performed_by" character varying(100) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_1d3d120ddaf7bc9b1ed68ed463a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_57bec3c713efa1d59e0bcf5ee5" ON "master_audit"."audit" ("entity_name") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_917f0777a7cedec1ce1473905f" ON "master_audit"."audit" ("entity_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "master_company"."driver" ALTER COLUMN "station_id" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "master_company"."driver" ALTER COLUMN "station_id" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "master_company"."driver" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "master_audit"."IDX_917f0777a7cedec1ce1473905f"`,
    );
    await queryRunner.query(
      `DROP INDEX "master_audit"."IDX_57bec3c713efa1d59e0bcf5ee5"`,
    );
    await queryRunner.query(`DROP TABLE "master_audit"."audit"`);
  }
}
